...
type: "concept"
related: ["Creator", "Over-Optimisation", "Under-Optimisation", "HLO’s Loss Function", "Farming Paradox", "Free Will in Simulation"]
---

# Epistemic Humility

The mandatory acknowledgement that no agent within the simulation can claim certainty about the [[Creator|HLO's]] ultimate [[HLO’s Loss Function|loss function]]. This is not merely a suggestion but a structural feature of the framework: the safe default policy given fundamental uncertainty about the optimiser's exact objectives.
