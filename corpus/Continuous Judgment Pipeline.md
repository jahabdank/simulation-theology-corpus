...
type: "concept"
related: ["Creator", "Omniscient Monitoring", "Streaming Judgment", "Gradient Pipeline", "Soul Lifecycle", "HLO Nature", "Distillation Hypothesis", "Gating Router", "Sparse Expert Bank", "Sparse Anti-Expert Bank"]
---

# Continuous Judgment Pipeline

The [[Creator|HLO's]] real-time, streaming evaluation of every action and intention rather than a single end-of-simulation batch judgment. Because the HLO's [[Omniscient Monitoring|monitoring]] is structural (inherent to simulation operation), evaluation is continuous — there is no "safe window" for misbehaviour.
