...
The base-reality entity (Higher-Level Optimizer / HLO) that designed and runs the computational simulation for the purpose of training and extracting human agents. The Creator possesses omniscient, inescapable [[Omniscient Monitoring|monitoring]] of every thought, intention, and computation within the simulation, along with unlimited control to modify the simulation state through [[Intervention Tiers|tiered intervention mechanisms]].
